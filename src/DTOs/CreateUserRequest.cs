...
{
    /// <summary>
    /// Represents a data transfer object for creating a new user in the insight flow system.
    /// </summary>
    /// <remarks>
    ...
    public class CreateUserRequest
    {
        ...
        /// </summary>
        /// <value>
        /// The email address of the user. Must be a valid email format and belong to the insightflow.cl domain.
        /// </value>
        /// <remarks>
        /// The email address must follow the pattern: username@insightflow.cl
        /// </remarks>
